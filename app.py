...
openai_key = "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"
...
db_chain = SQLDatabaseChain.from_llm(llm, db, verbose=True,return_intermediate_steps=True, top_k = 5)
...
async def chat(reqeust: Request):
    ...
    query = body['query']
    additional_query = """Select top 5.Use the following JSON format and the output should be JSON array.
    For example,
    { `coulmn name` : `value`,
       `coulmn name` : `value`,  
      ...
